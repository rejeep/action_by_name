...
public abstract class ActionController
{
   ...
   * the Component that the event was fired on.
   */
  ...
  /**
   * Calls the method in the controller with the same name as the
   * components name. If no such method exists, {@link
   * ApplicationController#methodMissing methodMissing} is called.
   */
  ...
  /**
   * Calls the method on this class whose name is same as
   * <code>name</code>.
   *
   ...
   *
   * @exception NoSuchMethodException If no method named
   * <code>action</code> exits.
   * @exception Exception If any other error occur.
   */
